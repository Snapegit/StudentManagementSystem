			...
			<div class="data_box">
				<div class="data_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="考勤日期" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="考勤类型" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.kaoqinleixing}}
							</template>
						</el-table-column>
						<el-table-column label="第几周" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.dijizhou}}
							</template>
						</el-table-column>
						<el-table-column label="第几节" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.dijijie}}
							</template>
						</el-table-column>
